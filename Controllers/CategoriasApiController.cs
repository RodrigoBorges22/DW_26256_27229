...
namespace DW_26256_27229.Controllers
{
    ...
    public class CategoriasApiController : ControllerBase
    {
        ...
        // GET: api/CategoriasApi (Ler todas as categorias)
        [HttpGet]
        ...
        // GET: api/CategoriasApi/5 (Ler uma categoria pelo ID)
        [HttpGet("{id}")]
        ...
        // POST: api/CategoriasApi (Criar nova categoria)
        [HttpPost]
        ...
        // PUT: api/CategoriasApi/5 (Editar uma categoria)
        [HttpPut("{id}")]
        ...
        // DELETE: api/CategoriasApi/5 (Apagar uma categoria)
        [HttpDelete("{id}")]
